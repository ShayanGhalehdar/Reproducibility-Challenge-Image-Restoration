...
train_input_images_folder  = 'a/SIDD/train/input'
train_target_images_folder = 'a/SIDD/train/target'
...
train_input_patches_folder = "a/SIDD/train/input_patches"
os.makedirs(train_input_patches_folder, exist_ok=True)

train_target_patches_folder = "a/SIDD/train/target_patches"
os.makedirs(train_target_patches_folder, exist_ok=True)

test_input_images_folder = "a/SIDD/test/input"
os.makedirs(test_input_images_folder, exist_ok=True)

test_target_images_folder = "a/SIDD/test/target"
os.makedirs(test_target_images_folder, exist_ok=True)

test_input_patches_folder = "a/SIDD/test/input_patches"
os.makedirs(test_input_patches_folder, exist_ok=True)

test_target_patches_folder = "a/SIDD/test/target_patches"
