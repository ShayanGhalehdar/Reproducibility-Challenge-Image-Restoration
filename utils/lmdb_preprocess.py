...
#zip test_input_patches_folder and test_target_patches_folder seperately and save
...
shutil.move('test_input_patches.zip', '/content/drive/MyDrive/test_input_patches.zip')

shutil.move('test_target_patches.zip', '/content/drive/MyDrive/test_target_patches.zip')